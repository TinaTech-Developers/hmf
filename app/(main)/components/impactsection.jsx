...
import { Users, BookOpen, Droplet, Leaf } from "lucide-react";
import React from "react";

const stats = [
  { id: 1, icon: BookOpen, number: "20+", label: "Children Assisted" },
  { id: 2, icon: Users, number: "0+", label: "Elderly People Assisted" },
  { id: 3, icon: Droplet, number: "1+", label: "Projects" },

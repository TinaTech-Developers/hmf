...
export default function ViewProgramPage() {
  ...
  const statusColors = {
    Active: "bg-lime-100 text-[#9bce1c]",
  ...
  const handleSave = async (updatedProgram) => {
    if (!program) return;
    try {
    ...
    <DashboardLayout>
      <div className="max-w-5xl mx-auto p-6 space-y-6">
        ...
        <motion.div
          ...
          className="bg-linear-to-r from-[#A7CE44] to-[#b7ff00] text-white rounded-2xl p-6 shadow-lg flex justify-between items-center"
        >
          <div>
        ...
        >
          <button
            onClick={openModal}
            className="px-5 py-2 bg-[#A7CE44] hover:bg-[#b7ff00] text-white rounded-xl transition shadow"
          >
            Edit Program
          </button>
        </motion.div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex justify-end gap-2 mt-4">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 bg-[#A7CE44] text-white rounded-lg hover:bg-[#a6e012] transition"
                    >
                      Save
                    </button>
                  </div>
